...
export default {
	...
	, methods:{
		fnGetList() { //데이터 가져오기 함수
			...
			axios.get('http://localhost:3000/api/board',{params:this.body})
			.then((res)=>{
				if(res.data.success) {
...
<style scoped>
	...
	.tbList th{border:1px solid gray; padding:5px 0;}
    .tbList td{border:1px solid lightgray; padding:5px 0 ;}
	.tbList td.txt_left{text-align:center;}
